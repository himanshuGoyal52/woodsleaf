                                     ...
                                     <div  className="social-sharing">
                                         <div  className="widget widget_socialsharing_widget" style={{backgroundColor : '#efebd9'}}>
                                             ...
                                             <ul  className="social-icons">
                                                 <li> <WhatsappShareButton title={product?.name} separator='||' url={`https://www.woodsleaf.com/product/${product?.slug}`}> <a target="_blank" title="Whatsapp"   className="gplus social-icon"><i  className="zmdi zmdi-whatsapp"></i></a> </WhatsappShareButton></li>
                                                 <li> <TwitterShareButton title={product?.name} url={`https://www.woodsleaf.com/product/${product?.slug}`} > <a target="_blank" title="Twitter"   className="twitter social-icon"><i  className="zmdi zmdi-twitter"></i></a> </TwitterShareButton></li>
                                                 <li> <FacebookShareButton quote={product?.name} hashtag='#woodsleaf' url={`https://www.woodsleaf.com/product/${product?.slug}`}><a target="_blank" title="Facebook"   className="facebook social-icon"><i  className="zmdi zmdi-facebook"></i></a> </FacebookShareButton> </li>
                                                 <li> <LinkedinShareButton title={product?.name} url={`https://www.woodsleaf.com/product/${product?.slug}`}><a target="_blank" title="LinkedIn"   className="linkedin social-icon"><i  className="zmdi zmdi-linkedin"></i></a> </LinkedinShareButton></li>
                                             </ul>
                                         </div>
                                     </div>
                                 </div>
