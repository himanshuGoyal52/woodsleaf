      ...
      <div className="grid md:grid-cols-4 md:gap-5">
        ...
        <div className="admin-overflow">
          <div className="flex justify-between">
            <h1 style={{marginBottom : '1rem' , fontSize : '1.25rem' , lineHeight : '1.75rem'}}>Products</h1>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full">
                <thead className="border-b">
                  <tr>
                    <th className="px-5 text-left">SKU</th>
                    ...
                    <tr key={product._id} className="border-b">
                      ...
                      <td className=" p-5 ">
                        <Link
                          ...
                          data-text ="Edit"
                          style={{margin:'15px 0'}}
                          className="m-15 button-one floatleft text-uppercase" 
                        >
                          Edit
                        </Link>
                        &nbsp;
